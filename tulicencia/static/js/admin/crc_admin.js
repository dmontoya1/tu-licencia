;(function($) {
    ...
    $(document).ready(function(){
        ...
        axios.defaults.headers.common['Api-Key'] = '98697b3f36dfaefb7f7f70e32be3dbde418c078b'

        function disableCompany(nit){
            params = {}
            params ['nit'] = nit
            axios.post('/api/companies/disable-crc', params)
        ...
        function enableCompany(nit){
            params = {}
            params ['nit'] = nit
            axios.post('/api/companies/enable-crc', params)
            .then(function (response) {
                data = response.data;
                swal({
                    title: 'Atención!',
        ...
        $('.request-soft').on('click', function(ev){
            ...
            swal({
                ...
                if (result.value) {
                    axios.get('/api/request/crc-pending/', {
                        params: {
                            nit: nit
                        }
                    })
